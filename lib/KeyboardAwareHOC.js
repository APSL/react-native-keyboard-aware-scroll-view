...
const KeyboardAwareMixin = {
              ...
              (x, y, width, height) => {
                ...
                if (Platform.OS === 'ios') {
                  if (
                    ...
                    this.scrollToFocusedInputWithNodeHandle(
                      currentlyFocusedField
                    )
                  }
                } else {
  ...
  getScrollResponder() {
    return (
      this._rnkasv_keyboardView && this._rnkasv_keyboardView.getScrollResponder()
    )
  },
  ...
  scrollToFocusedInputWithNodeHandle: function(
    nodeID: number,
    extraHeight: number,
    keyboardOpeningTime: number
  ) {
...
export default KeyboardAwareHOC
